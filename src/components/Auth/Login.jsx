...
function Login() {
    ...
    return (
        <div className="flex w-full h-full justify-center items-center" style={{backgroundColor: "#e6e6e6"}}>
            <div className="container mx-auto p-3 my-5">
                <div className="flex flex-row">
                    ...
                    <div className="w-full p-5 rounded-3xl md:w-4/12 flex justify-center items-center flex-col mb-5"
                        style={{backgroundColor: "#ffffff"}}
                        >
                        <img
                            className="mx-auto w-3/4 md:w-full mb-10"
                            style={{ width: "250px" }}
                            src={logo}
                            alt=""
                        />
                        ...
                        <div className="text-sm">Chưa có tài khoản? <Link to='/register'>Đăng ký</Link> </div>
                    </div>
                </div>
            </div>
