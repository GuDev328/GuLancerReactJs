            ...
            <div className="container mx-auto p-3 my-5">
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-1/2 rounded-3xl p-8"
                        ...
                        <img
                            className="img-fluid mx-auto w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3 mb-4"
                            style={{ width: "250px" }}
                            src={logo}
                            alt=""
                        />
                        ...
                        <div className="flex justify-around items-center mb-4">
                            <Button className='p-4 focus:outline-none border-0' style={{backgroundColor: chooseRole==='freelancer'? '#6c7ee1':'#333'}}
                                onClick={()=>setChooseRole('freelancer')}
                            >Tôi là Freelancer</Button>
                            <Button className='p-4 focus:outline-none border-0' style={{backgroundColor: chooseRole==='employer'? '#6c7ee1':'#333'}}
                                onClick={()=>setChooseRole('employer')}
                            >Tôi là Employer </Button>
                        </div>
                        <div className='w-full flex justify-center items-center flex-col'>
                            <Button className='w-full focus:outline-none' style={{backgroundColor: '#6c7ee1'}}
