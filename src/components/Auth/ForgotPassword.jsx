        ...
        <div className="flex w-full h-full justify-content-center items-center ">
            <div className="container mx-auto p-3">
                <div className="flex flex-row">
                    ...
                    <div className="w-full md:w-4/12 p-8 flex rounded-3xl justify-center items-center flex-col"
                    style={{backgroundColor: "#ffffff", height: "300px"}}>
                        <img
                            className="mx-auto w-3/4 md:w-full mb-9"
                            style={{ width: "250px" }}
                            src={logo}
                            alt=""
                        />
                        ...
                        <div className='text-md'>Chưa có tài khoản? <Link to='/register'>Đăng ký</Link> </div>
                    </div>
                </div>
            </div>
            <ToastContainer />
