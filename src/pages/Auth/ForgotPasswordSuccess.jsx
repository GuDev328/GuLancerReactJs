        ...
        <div className="flex flex-row">
          ...
          <div className="w-full lg:w-6/12 flex justify-center items-center flex-col">
            ...
            <p className="text-center my-5">
              Chúng tôi đã gửi một email xác thực thay đổi mật khẩu đến địa chỉ
              email của bạn. Bạn hãy vui lòng kiểm tra email. <br />
              Lưu ý email này chỉ có giá trị trong vòng 1 tiếng kể từ bây giờ.
            </p>
