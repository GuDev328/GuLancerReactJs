            ...
            <div className="container mx-auto p-3 my-5">
                <div className="flex flex-row">
                    ...
                    <img
                        ...
                        Chúc mừng bạn đã đăng ký tài khoản thành công. <br/>Chúng tối đã gửi mật khẩu đến địa chỉ email của bạn. Bạn hãy vui lòng kiểm tra email và tiến hành đăng nhập.
