            ...
            <Form form={form}>
                ...
                <div className="flex gap-2 mb-2">
                    ...
                    <Button2
                        ...
                        className={
                            salaryType === 0 ? "bg-blue-500" : "bg-gray-500"
                        }
                        size="sm"
                    >
                        Theo mô tả
                    ...
                    <Button2
                        className={
                            salaryType === 1 ? "bg-blue-500" : "bg-gray-500"
                        }
                        size="sm"
                ...
                <div className="flex gap-2 mb-2">
                    ...
                    <Button2
                        ...
                        className={
                            timeType === 0 ? "bg-blue-500" : "bg-gray-500"
                        }
                        size="sm"
                    >
                        Theo mô tả
                    ...
                    <Button2
                        className={
                            timeType === 1 ? "bg-blue-500" : "bg-gray-500"
                        }
                        size="sm"
                        ...
                        rules={[
                            {
                                required: true,
                                message:
                                    "Vui lòng nhập thời gian hoàn thành đề xuất",
                            },
                        ]}
