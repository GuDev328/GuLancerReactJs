        ...
        <div className="flex w-full h-full justify-center items-center">
            <div className="container mx-auto p-3 my-5">
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="w-full lg:w-1/2 rounded-3xl p-8"
                        ...
                        <div className="flex justify-around items-center mb-4">
                            <Button className='p-4 focus:outline-none border-0' style={{backgroundColor: chooseRole==='freelancer'? '#2881E2':'#333'}}
                                onClick={()=>setChooseRole('freelancer')}
                            >Tôi là Freelancer</Button>
                            <Button className='p-4 focus:outline-none border-0' style={{backgroundColor: chooseRole==='employer'? '#2881E2':'#333'}}
                                onClick={()=>setChooseRole('employer')}
                            >Tôi là Employer </Button>
                        </div>
                        <div className='w-full flex justify-center items-center flex-col'>
                            <Button className='w-full focus:outline-none' style={{backgroundColor: '#2881E2'}}
